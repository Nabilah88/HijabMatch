...
import seasonsIcon        from "../../assets/seasons.png";
import headIcon     from "../../assets/head_ud.svg"

import modelPhoto from "../../assets/seasonalcolor.png";
  ...
  >
    ...
    >
      Feature 02
        ...
        >
          <span style={{ color: "white" }}>Seasonal </span>
          <span style={{ color: "#F48FB1" }}>Color</span>
          {"\n"}
          <span style={{ color: "#F48FB1" }}>Classification</span>
        </Text>
        ...
        >
          We determine whether you are Spring, Summer, Autumn, or Winter based on advanced color theory and AI.
        </Text>
        <Box gap="14px" margin={{ bottom: "36px" }}>
          <Badge
            ...
            sublabel="Identifies your unique season (Spring, Summer, Autumn, or Winter)"
          />
          <Badge
            iconSrc={AiIcon}
            iconAlt="AIandColorTheory"
            label="AI + Color Theory"
            sublabel="Uses proven color theory combined with AI for accuracy"
          />
          <Badge
            iconSrc={headIcon}
            iconAlt="Glow"
            label="Deeper Understanding"
            sublabel="Helps you understand why certain colors enhance your natural glow"
          />
        </Box>
      </Box>
    </Box>
